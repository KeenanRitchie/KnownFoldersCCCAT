...
Set-KnownFolderPath -KnownFolder 'Pictures' -Path "$ONEDRIVESYNC\Documents\Pictures"
...
Set-KnownFolderPath -KnownFolder 'Music' -Path "$ONEDRIVESYNC\Documents\Music"
Set-KnownFolderPath -KnownFolder 'Videos' -Path "$ONEDRIVESYNC\Documents\Videos"
